...
def read_data():
    position1 = np.loadtxt('/home/y/From yuqiang/code/Robot_Position9.txt')
    position3 = np.loadtxt('/home/y/From yuqiang/code/Robot_Position14.txt')
    position4 = np.loadtxt('/home/y/From yuqiang/code/Robot_Position12.txt')
    position5 = np.loadtxt('/home/y/From yuqiang/code/Robot_Position13.txt')
